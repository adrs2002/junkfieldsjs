...
function Obj_Track_1()
{
    ObjectSetter.call(this, "Track_1");
}

//オブジェクトのロードメソッド
Obj_Track_1.prototype.load = function (object) {
    ...
    self.meca_Stat_Const_f[cEnConsts_ParamF.warkS_max] = 0.36; //歩行速度最大値	
    ...
    self.meca_Stat_Const_f[cEnConsts_ParamF.life_max] = 355; //HP最大値	
...
inherits(Obj_Track_1, ObjectSetter);
