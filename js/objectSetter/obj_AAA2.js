...
function Obj_AAA_2()
{
    ObjectSetter.call(this, "Tank");
}

//オブジェクトのロードメソッド
Obj_AAA_2.prototype.load = function (object) {
    ...
    self.meca_Stat_Const_f[cEnConsts_ParamF.life_max] = 1255; //HP最大値	
...
inherits(Obj_AAA_2, ObjectSetter);
